  ...
  return (
    ...
    >
      ...
      <g filter="url(#filter0_i_19_829)">
        <path
          d="M144.65 174.895C127.576 158.504 103.671 155.089 88.6458 155.089C73.6203 155.089 50.1762 158.504 33.1016 174.895C16.0271 191.287 13.3626 204.187 18.759 209.044C24.7846 214.467 35.063 207.663 41.6211 200.827C42.3066 200.112 43.5346 200.707 43.3203 201.673C41.7302 208.849 39.4139 216.96 42.6634 231.582C45.3953 243.876 48.8102 245.242 48.8102 255.487C48.8102 260.268 46.0783 273.244 54.957 275.976C62.983 278.446 77.148 268.637 81.8128 255.127C82.6753 252.629 84.8884 250.706 87.5311 250.706H88.6458H90.2208C92.8635 250.706 95.0765 252.629 95.939 255.127C100.604 268.637 114.769 278.446 122.795 275.976C131.674 273.244 128.942 260.268 128.942 255.487C128.942 245.242 132.357 243.876 135.088 231.582C138.338 216.96 136.022 208.849 134.432 201.673C134.217 200.707 135.445 200.112 136.131 200.827C142.689 207.663 152.967 214.467 158.993 209.044C164.389 204.187 161.725 191.287 144.65 174.895Z"
          fill="#FFD9B9"
        />
      </g>
      <g filter="url(#filter1_i_19_829)">
        <path
          d="M171.153 67.2983C157.552 31.3941 136.54 14.1069 121.982 7.71471C109.997 2.15007 99.1134 0.0927055 88.9454 -0.000488281C78.7773 0.0927055 67.2415 2.15007 55.2569 7.71471C40.6984 14.1069 19.6862 31.3941 6.08582 67.2983C-0.12669 83.699 -1.53403 103.284 1.64024 116.924L1.71552 117.248C4.8952 130.921 12.7064 152.995 48.2785 165.395C59.8289 169.626 80.2793 172.126 88.9454 172.126C97.6115 172.126 117.41 169.626 128.96 165.395C164.532 152.995 172.779 130.921 175.959 117.248L176.034 116.924C179.209 103.284 177.365 83.699 171.153 67.2983Z"
          fill="#FFD9B9"
        />
      </g>
      <path
        d="M79 142.312C82.1884 145.613 90.6522 150.236 99 142.312"
        stroke="#75441D"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
      ...
      <path
        d="M51 82.1888C56.0862 77.7462 63.7655 76.0584 72.3749 80.2652"
        stroke="#75441D"
        strokeWidth="1.78125"
        strokeLinecap="round"
      />
      <circle
        ...
        cy="5.93751"
        r="5.93751"
        transform="matrix(-1 0 0 1 121.535 91.3037)"
        fill="#75441D"
      />
      <path
        d="M127 82.1888C121.914 77.7462 114.235 76.0584 105.625 80.2652"
        stroke="#75441D"
        strokeWidth="1.78125"
        strokeLinecap="round"
      />
