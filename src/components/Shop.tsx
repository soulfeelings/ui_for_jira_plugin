...
export const Shop: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      <div
        className={`pointer-events-auto relative p-[25px] max-w-lg mx-auto flex flex-col bg-[#DFD1C1]/30 ${isMobile ? 'min-w-[300px] min-h-[300px] w-[300px] h-[300px]' : 'min-w-[500px] min-h-[500px] w-[500px] h-[500px]'} rounded-[50px]`}
      >
        {!isMobile && (
